...
class Articles extends React.Component {
  ...
  onEditor() {
    let editor = new wangEditor(document.getElementById('news-editor'));
  ...
  destroy() {
    ...
    document.getElementById('news-wrapper').append(div);
  }
  ...
  onSave() {
    ...
    if(!path[3]) {
      request.publishArticles(data).then((res) => {
        ...
        router.replaceState('/admin/blog/news-list', null, null, false);
      }).catch((err) => {
        tip({
          content: '保存失败！',
          autoHide: true,
  ...
  render() {
    let state = this.state;
    return (
      <div className="blog-module-news" style={this.props.style}>
        <div className="top-bar">
          <div className="left">
            <ul>
              <li>
                <span className='circle active'></span><p>新闻</p>
              </li>
            </ul>
          </div>
          <div className="right">
        ...
        <div className="third-bar">
          <div className="left">
            ...
            <div className="editor-wrapper" id="news-wrapper">
              <div id="news-editor" className="editor">
