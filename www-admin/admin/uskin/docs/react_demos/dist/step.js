...
var StepForm1 = function (_React$Component) {
  (0, _inherits3.default)(StepForm1, _React$Component);

  function StepForm1() {
    (0, _classCallCheck3.default)(this, StepForm1);
    return (0, _possibleConstructorReturn3.default)(this, (StepForm1.__proto__ || (0, _getPrototypeOf2.default)(StepForm1)).apply(this, arguments));
  }

  (0, _createClass3.default)(StepForm1, [{
    key: 'onClick',
...
var StepForm2 = function (_React$Component2) {
  (0, _inherits3.default)(StepForm2, _React$Component2);

  function StepForm2() {
    (0, _classCallCheck3.default)(this, StepForm2);
    return (0, _possibleConstructorReturn3.default)(this, (StepForm2.__proto__ || (0, _getPrototypeOf2.default)(StepForm2)).apply(this, arguments));
  }

  (0, _createClass3.default)(StepForm2, [{
    key: 'onClick',
    value: function onClick(index) {
      this.refs.step.setState({
        selectedIndex: index
