...
var Example = function (_React$Component) {
  ...
  function Example(props) {
    ...
    ['listener1', 'listener2', 'labelListener', 'changeLabel'].forEach(function (func) {
  ...
  (0, _createClass3.default)(Example, [{
    key: 'listener1',
    value: function listener1(page, e) {
    ...
    key: 'listener2',
    value: function listener2(page, e) {
      console.debug('click triggered!', page, e);
      this.setState({
        value2: page
      });
    ...
    key: 'labelListener',
    value: function labelListener(label, e) {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(Button, { value: 'Jump to 17', onClick: this.pageJump.bind(this, 17) })
          ),
          React.createElement(Pagination, { onClick: this.listener1, current: state.value1, total: 20 })
        ),
        React.createElement(
          'div',
          null,
          ...
          React.createElement(Pagination, { onClick: this.listener2, current: state.value2, total: 5 })
        ),
        React.createElement(
          'div',
          null,
