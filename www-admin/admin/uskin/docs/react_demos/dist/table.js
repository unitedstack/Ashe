...
var TableForm = function (_React$Component) {
  (0, _inherits3.default)(TableForm, _React$Component);

  function TableForm(props) {
    (0, _classCallCheck3.default)(this, TableForm);

    var _this = (0, _possibleConstructorReturn3.default)(this, (TableForm.__proto__ || (0, _getPrototypeOf2.default)(TableForm)).call(this, props));
    ...
    ['inputSearchOnChange', 'updateData', 'toggleLoading', 'clearState'].forEach(function (func) {
      _this[func] = _this[func].bind(_this);
    });
    return _this;
  }

  (0, _createClass3.default)(TableForm, [{
    key: 'checkboxInitialize',
    value: function checkboxInitialize(item) {
      return item.level.indexOf('Second Level') > -1;
    }
  }, {
    key: 'checkboxOnChange',
    value: function checkboxOnChange(status, item, arr) {
      console.debug('checkbox on change', status, item, arr);
    }
  }, {
    key: 'checkboxOnChangeAll',
    value: function checkboxOnChangeAll(status, arr) {
      console.debug('checkbox on change all', status, arr);
    }
  }, {
    key: 'inputSearchOnChange',
    value: function inputSearchOnChange(text, status) {
      var filterCol = {
        category: true,
        level: true,
        price: true
