...
Modal.prototype._setModalContent = function(modal) {
  ...
  var btnStyleText = 'padding: 5px; text-align: center; border-radius: 2px; border: 1px solid; font-size： 14px; line-height: 20px; display:block; margin: 0 auto; background: white; font-weight: 200;';
