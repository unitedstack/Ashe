...
PageNav.prototype.gotoPage = function(number){
  ...
  if(this.pageAmount <= 7){
    ...
    for(var i = 1; i <= 4; i ++) {
      $("<a></a>").addClass("nBtn").html(i).appendTo(this.$box);
    }
    ...
    $("<a></a>").addClass("ellipsis").html("...").appendTo(this.$box);
    for(var i = -1; i <= 1; i ++) {
      $("<a></a>").addClass(i !== 0 ? "nBtn" : "nBtn cur").html(this.page + i).appendTo(this.$box);
    }
    $("<a></a>").addClass("ellipsis").html("...").appendTo(this.$box);
    $("<a></a>").addClass("nBtn").html(this.pageAmount).appendTo(this.$box);
    $("<a></a>").addClass("cNext").html(arrowRight).appendTo(this.$box);
    ...
    $("<a></a>").addClass("ellipsis").html("...").appendTo(this.$box);
    for(var i = -2; i <= 0; i ++) {
      $("<a></a>").addClass("nBtn").html(this.pageAmount + i).appendTo(this.$box);
    }
